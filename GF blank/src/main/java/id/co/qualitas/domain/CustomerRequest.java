...
public class CustomerRequest extends MasterDomain {
	private String id;
	...
	public int getEnabledCustomer() {
		return enabledCustomer;
	}
	public void setEnabledCustomer(int enabledCustomer) {
