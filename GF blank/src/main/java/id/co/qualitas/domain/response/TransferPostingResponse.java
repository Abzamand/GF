...
public class TransferPostingResponse {
	...
	private List<TransferPostingDetailResponse> listDetail;
	
	public TransferPostingResponse() {
		super();
	...
	public List<TransferPostingDetailResponse> getListDetail() {
		return listDetail;
	}

	public void setListDetail(List<TransferPostingDetailResponse> listDetail) {
