...
public class GoodReceiptFGMaterialResponse {
	...
	private List<GoodReceiptFGComponentResponse> listComponent;
	...
	public List<GoodReceiptFGComponentResponse> getListComponent() {
		return listComponent;
	}
	public void setListComponent(List<GoodReceiptFGComponentResponse> listComponent) {
